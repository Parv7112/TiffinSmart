...
function Testimonials() {
  ...
  const items = [
    <div class="frosted-glass pb-4 text-center cardglass">
      <img
        src="/assets/images/testoimg.png"
        className="w-25"
        style={{ marginTop: "-50px" }}
      ></img>
      <h1 class="title text-center py-4 titletesto">Anjali Singh Tawar</h1>
    ...
    <div class="frosted-glass pb-4 text-center cardglass">
      <img
        ...
        style={{ marginTop: "-50px" }}
      ></img>
      <h1 class="title text-center py-4">Anjali Singh Tawar</h1>
